...
public class Bootcamp {
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataInicial, descricao, devsInscritos, name);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dataFinal, other.dataFinal)
				...
				&& Objects.equals(devsInscritos, other.devsInscritos) && Objects.equals(name, other.name);
	}
